...
class Course {
    ...
    public String toString(){
        return "Registered: "+this.code+" - "+this.title;
    }
}
...
abstract class Student implements Printable {
    ...
    public void registerCourse(Course c) throws CourseLimitExceededException{
        if(this.courses.size()>=getMaxCourses()) throw new CourseLimitExceededException(this.name+" cannot register for more than "+getMaxCourses()+" courses.");
        this.courses.add(c);
    }
    public String toString(){
