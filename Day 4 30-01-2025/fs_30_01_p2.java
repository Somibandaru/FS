...
public class fs_30_01_p2{
    public static void main(String args[]){
        ...
        int points = 0, t = 0, e = 0, l = 0;
        for(int r=0;r<n;r++){
            t += tasks[r];
            e += hours[r];
            if((r-l+1)==k){
                if(t < lower && e >= workGoal) points -= 2;
                else if(t < lower && e < workGoal) points -= 1;
                else if(t >= upper && e >= workGoal) points += 1;
                else if(t >= upper && e < workGoal) points += 2;
                t -= tasks[l];
                e -= hours[l];
                l++;
            }
